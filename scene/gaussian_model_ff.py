...
class FeatureGaussianModel:
    ...
    def densification_postfix(self, new_xyz, new_knn_f, new_point_features, new_opacities, new_scaling, new_rotation):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, grads_abs, grad_abs_threshold, scene_extent, max_radii2D, N=2):
        ...
        self.densification_postfix(new_xyz, new_knn_f, new_point_features, new_opacity, new_scaling, new_rotation)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_knn_f, new_point_features, new_opacities, new_scaling, new_rotation)
