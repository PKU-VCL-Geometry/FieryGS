...
def render_PGSR(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, 
...
def render_mask_PGSR(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, 
           app_model: AppModel=None, return_plane = True, return_depth_normal = True):
    """
    Render the scene. 
...
from diff_plane_rasterization_contrastive_f import GaussianRasterizationSettings as PlaneGaussianRasterizationSettingsContrastiveF
from diff_plane_rasterization_contrastive_f import GaussianRasterizer as PlaneGaussianRasterizerContrastiveF

def render_contrastive_feature_PGSR(viewpoint_camera, pc : FeatureGaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, 
           app_model: AppModel=None, return_plane = True, return_depth_normal = True, norm_point_features = False, smooth_type = None, smooth_weights = None, smooth_K = 16):
    """
    Render the scene. 
    ...
    return_dict = None
    raster_settings = PlaneGaussianRasterizationSettingsContrastiveF(
            image_height=int(viewpoint_camera.image_height),
            image_width=int(viewpoint_camera.image_width),
            tanfovx=tanfovx,
            tanfovy=tanfovy,
    ...
    rasterizer = PlaneGaussianRasterizerContrastiveF(raster_settings=raster_settings)
