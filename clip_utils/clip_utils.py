...
def download_file(url: str, dest_path: str):
    """Simple download function that downloads a file from a given URL to the destination path"""
...
class OpenCLIPNetworkConfig:
    ...
    clip_model_pretrained: str = os.environ.get("CLIP_PRETRAINED_PATH", "./clip_ckpt/ViT-B-16-laion2b_s34b_b88k.bin")
    clip_n_dims: int = 512
...
class OpenCLIPNetwork(nn.Module):
    def __init__(self, config: OpenCLIPNetworkConfig):
        ...
        # self.tokenizer = open_clip.get_tokenizer('hf-hub:laion/CLIP-ViT-B-16-laion2B-s34B-b88K')      
